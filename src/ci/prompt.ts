    ...
    case 'artefakt':
      ...
      */
      return [
        ...
        '2. **Zähle nicht nur — frage, was eine Farbe tut.** Die Fläche über die',
        '   ganze Folie ist das Papier, die Farbe eines Textlaufs ist Tinte oder',
        '   Signal, und was *innerhalb* der Logo-Gruppe steht, gehört dem Logo',
        '   und nicht der Palette. Nach Häufigkeit allein greifst du daneben:',
        '   gemessen an einer echten Vorlage waren die beiden meistgenannten',
        '   Farben die Weiß- und Grautöne des Schriftzugs, und die Signalfarbe',
        '   stand auf Platz sechs.',
        ...
        '   Größe der Marke.',
        `4. **Größen sind Folien-Einheiten, nicht Punkt.** Eine Einheit ist ${komma(PUNKT_JE_EINHEIT)} Punkt:`,
        `   teile jede Punktangabe durch ${komma(PUNKT_JE_EINHEIT)}. Aus 60 pt werden ${60 / PUNKT_JE_EINHEIT}, aus 18 pt werden ${18 / PUNKT_JE_EINHEIT}.`,
        '   Wer das vergisst, liefert eine Leiter, die ein Drittel zu klein ist —',
        '   und nichts daran sieht falsch aus.',
        '5. **Nicht jede Markenfarbe steht im XML.** Deko-Flächen und Verläufe',
        '   liefern Zeichenprogramme oft als eingebettetes Bild; ihre Farben',
        '   stehen dann allein in den Pixeln. Sieh in `ppt/media/` nach — an',
        '   jener Vorlage lag `<a:gradFill>` kein einziges Mal im XML, und zwei',
        '   der drei Markenorange waren nur dort zu finden. Einen Verlauf nimmst',
        '   du an seinen Enden für `signal` und `signalStrong`; eine Fläche ist',
        '   hier immer Vollton.',
