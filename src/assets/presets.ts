...
export const assetPresets: AssetPreset[] = [
  ...
  preset(
    ...
    'type',
    'text',
    { text: 'Abschnitt', typeStyle: 'label', w: 304, h: 24 },
  ...
  /* ---------------------------------------------------------------- Formen */
  preset('shape-rectangle', 'Rechteck', 'shapes', 'shape', { shape: 'rectangle', w: 280, h: 184 }),
  ...
  preset('shape-triangle', 'Dreieck', 'shapes', 'shape', { shape: 'triangle', w: 200, h: 176 }),
  preset('shape-hexagon', 'Sechseck', 'shapes', 'shape', { shape: 'hexagon', w: 224, h: 192 }),
  ...
  preset('shape-cross', 'Kreuz', 'shapes', 'shape', { shape: 'cross', w: 184, h: 184 }),
